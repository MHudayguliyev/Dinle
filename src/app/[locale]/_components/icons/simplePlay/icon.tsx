...
const SimplePlayI = (props: SimplePlayI) => {
  ...
  return (
    <>
      {
        mode === 'pause' ? (
          <svg className={className} onClick={onClick} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg style={{pointerEvents: `${disable ? 'none': 'auto'}`}} className={className} onClick={onClick} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="59.2727" height="59.2727" rx="29.6364" fill="white"/>
